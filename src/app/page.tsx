      ...
      <div id="oriflame-products" data-section="oriflame-products" className={`${publicSans.variable} ${inter.variable}`}>
        <ProductCardThree
          products={[
            ...
            { "id": "oriflame-2", "name": "Milk and honey sugar scrub ", "price": "₦25.00", "imageSrc": "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3EV7r8jH6qVm4I9M2ve5zaDdSj6/uploaded-1780312219700-whgxfofd.jpg", "imageAlt": "Oriflame NovAge cleansing gel" },
            { "id": "oriflame-3", "name": "Wellness pack ", "price": "₦60.00", "imageSrc": "http://img.b2bpic.net/free-photo/front-view-rectangular-cologne-bottle-branch-rotten-wood-beige-background_140725-145548.jpg", "imageAlt": "Elegant Oriflame Giordani Gold perfume bottle" },
