      ...
      <div id="oriflame-products" data-section="oriflame-products" className={`${publicSans.variable} ${inter.variable}`}>
        <ProductCardThree
          products={[
            ...
            { "id": "oriflame-2", "name": "Milk and honey sugar scrub ", "price": "₦25.00", "imageSrc": "http://img.b2bpic.net/free-photo/liquid-facial-skin-care-product-white-background-isolated_169016-26906.jpg", "imageAlt": "Oriflame NovAge cleansing gel" },
