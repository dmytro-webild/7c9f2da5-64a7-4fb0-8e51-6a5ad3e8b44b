  ...
  return (
    ...
    >
      ...
      <div id="oriflame-benefits" data-section="oriflame-benefits" className={`${publicSans.variable} ${inter.variable}`}>
        <FeatureCardNineteen
          features={[
            ...
            { "tag": "Radiance", "title": "Unlock Your Natural Glow", "subtitle": "Confidence in Every Drop", "description": "Our range helps you achieve a healthy, radiant complexion. From nourishing skincare to enhancing makeup, Oriflame empowers you to feel confident and beautiful, every single day.", "imageSrc": "http://img.b2bpic.net/free-photo/close-up-portrait-happy-smiling-woman-talking-mobile-phone-from-her-kitchen-chatty-girl-with_1258-184102.jpg", "imageAlt": "Woman with radiant skin" },
            { "tag": "Variety", "title": "Diverse Product Portfolio", "subtitle": "Beauty for Every Need", "description": "Explore a comprehensive selection of skincare, makeup, fragrances, and wellness products. Whether you seek anti-aging solutions or vibrant cosmetics, MICHODAN has your Oriflame needs covered.", "imageSrc": "http://img.b2bpic.net/free-photo/overhead-view-professional-make-up-tools-eyeshadow-palette-colorful-background_23-2147971035.jpg", "imageAlt": "Variety of Oriflame beauty products" }
          ]}
      ...
      <div id="oriflame-products" data-section="oriflame-products" className={`${publicSans.variable} ${inter.variable}`}>
        <ProductCardThree
          products={[
            { "id": "oriflame-1", "name": "The ONE Colour Stylist Lipstick", "price": "$18.00", "imageSrc": "http://img.b2bpic.net/free-photo/foundation-container-beauty-blender_23-2149705493.jpg", "imageAlt": "Vibrant red Oriflame lipstick" },
