  ...
  return (
    ...
    >
      ...
      <div id="ankara-fabrics" data-section="ankara-fabrics" className={`${publicSans.variable} ${inter.variable}`}>
        <ProductCardThree
          products={[
            { "id": "ankara-1", "name": "Blue Geometric Ankara", "price": "₦15,000", "imageSrc": "http://img.b2bpic.net/free-photo/close-up-colorful-vintage-collar_23-2148237594.jpg", "imageAlt": "Royal blue geometric Ankara fabric roll" },
            { "id": "ankara-2", "name": "Purpule Ankara Print", "price": "₦15,000", "imageSrc": "http://img.b2bpic.net/free-photo/festive-ribbons-scissors-hips-white-background_114579-24042.jpg", "imageAlt": "Crimson red floral Ankara fabric roll" },
            { "id": "ankara-3", "name": "Orange leaf print Ankara", "price": "₦15,000", "imageSrc": "http://img.b2bpic.net/free-vector/background-with-green-blue-red-aztec-shapes_1271-49.jpg", "imageAlt": "Elegant purple swirl Ankara fabric roll" },
